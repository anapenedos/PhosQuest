...
from PhosQuest_app.data_access.display_tables import Kinase_results, \
    Substrate_results, Inhibitor_results, Phosphosite_results
from PhosQuest_app.data_access.query_db import searchlike, \
    searchexact, all_table, query_to_list
from PhosQuest_app.data_access.db_sessions import create_sqlsession
from PhosQuest_app.data_access.interface_dicts import location_cats, \
    kin_family_cats
import re
