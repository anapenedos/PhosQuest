...
The PhosphoQuest application requires an Sqlite3 database (`PhosphoQuest.db`) situated outside of the `PhosphoQuest_app` folder. In this location `run.py` is a script which activates the Flask application `PhosphoQuest_app`. 

### App Folder structure 
|
The structure of the software consists of a `PhosphoQuest_App` folder.This folder contains the `__init__.py` file that initiates the instance of teh PhosphoQuest Flask application. 
